...
# Ścieżka, w której będą przechowywane pliki
UPLOAD_FOLDER = 'uploads'
os.makedirs(UPLOAD_FOLDER, exist_ok=True)

# Strona HTML z dwiema zakładkami - Upload i Pliki
HTML_TEMPLATE = '''
<!doctype html>
<html lang="pl">
<head>
...
<body>
  <div class="container">
    <h1>System uploadu plików</h1>
    <div class="tabs">
      <button class="tab-button" onclick="showTab('uploadTab')">Upload</button>
      <button class="tab-button" onclick="showTab('filesTab')">Pliki</button>
    </div>
    
    <!-- Upload Tab -->
    <div id="uploadTab" class="content active">
      <h2>Wybierz plik do wysłania</h2>
...
def index():
    if request.method == "POST":
        ...
        if file:
            ...
            file.save(file_path)
            return render_template_string(HTML_TEMPLATE, files=os.listdir(UPLOAD_FOLDER), message=f"Plik '{file.filename}' został wysłany.")
